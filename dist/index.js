...
import require$$0$2 from '@actions/http-client';
import require$$1$1 from '@actions/http-client/lib/auth';
import require$$1$2 from '@actions/exec';
...
function requireOidcUtils () {
	...
	const http_client_1 = require$$0$2;
	const auth_1 = require$$1$1;
...
function requirePlatform () {
	...
	(function (exports) {
		...
		const exec = __importStar(require$$1$2);
...
async function run() {
  ...
  if (action === 'create_image') {
    return await tencent_cloud.create_image(
      coreExports.getInput('secret_id'),
      coreExports.getInput('secret_key'),
      coreExports.getInput('region'),
      coreExports.getInput('instance_name_prefix')
    )
    ...
    return await tencent_cloud.create_image_sync_as(
      ...
      coreExports.getInput('region'),
      coreExports.getInput('instance_name_prefix'),
      coreExports.getInput('launch_configuration_id')
    )
  }
}
